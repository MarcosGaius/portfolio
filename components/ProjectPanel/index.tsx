import { mainProject, otherProjects } from "./data";
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full">
        <h2 className="font-sans text-3xl font-bold m-auto">🧑‍💻 PROJETOS</h2>
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-0 md:gap-x-10">
            ...
            <Text className="text-xl text-center md:text-right opacity-90">{mainProject.description}</Text>
          </div>
        </div>
      </div>
      <ImageSlider title="Outros projetos" />
    </div>
  );
}
